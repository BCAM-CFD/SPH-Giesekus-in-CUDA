# SPH Giesekus in CUDA
SPH for the Giesekus model with wall boundaries and suspensions of spherical particles, implemented in CUDA.
...
alpha   -> alpha parameter of the Giesekus model
